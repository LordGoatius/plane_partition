...
pprint([[0, 1],[0,0]])
print("Is Partition:", plane_partitions.is_plane_partition([[0, 1],[0,0]]))
...
print("Complement = Rowmotion:", plane_partitions.complement(part) == plane_partitions.rowmotion(part))
part = [[5,5,5,5,5],[5,5,5,4,4],[3,3,3,2,1],[3,1,0,0,0],[2,0,0,0,0]]
for i in range(plane_partitions.rowmotion_orbit_length(part)):
    part = plane_partitions.rowmotion(part)
    print(plane_partitions.to_tikz_diagram(part))
